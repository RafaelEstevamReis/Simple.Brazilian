...
namespace Simple.Brazilian.Documents
{
    ...
    public static class PIS
    {
        ...
        public static string Mask(string pis) => Formatters.Text.AplicaMascara(pis, "___._____.__._");
        /// <summary>
        /// Remove a máscara
        /// </summary>
        /// <param name="pis">Texto com a máscara aplicada</param>
        /// <returns>Texto com a máscara removida</returns>
        public static string Unmask(string pis) => Formatters.Text.RemoveMascara(pis);
