...
namespace Simple.Brazilian.Documents
{
    ...
    public static class CNPJ
    {
        ...
        public static string Mask(string cnpj) => Formatters.Text.AplicaMascara(cnpj, "__.___.___/____-__");
        /// <summary>
        /// Remove a máscara
        /// </summary>
        /// <param name="cnpj">Texto com a máscara aplicada</param>
        /// <returns>Texto com a máscara removida</returns>
        public static string Unmask(string cnpj) => Formatters.Text.RemoveMascara(cnpj);
